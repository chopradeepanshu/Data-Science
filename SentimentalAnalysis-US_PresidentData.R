...
GetSentiment <- function(file){
  # get the file
  fileName <- glue("Data/PresidentSpeech-1989-2017/", file, sep = "")
  ...
  # tokenize
  tokens <- data_frame(text = fileText) %>% unnest_tokens(word, text, to_lower = TRUE)
...
#You can learn more about tokenization https://www.kaggle.com/rtatman/tokenization-tutorial
